...
const ProfileSelector = ({ profiles, currentProfileId, onSelect, onCreateNew }) => {
    return (
        <div className="bg-white/80 backdrop-blur-md border-b border-stone-200/60 py-3 md:py-4 px-4 md:px-6 flex justify-between items-center sticky top-0 z-40 shadow-sm transition-all">
            <div className="flex items-center gap-3 shrink-0">
                ...
                <span className="font-serif font-bold text-xl text-chef-950 tracking-tight hidden sm:block">Your-Kitchen</span>
            </div>
